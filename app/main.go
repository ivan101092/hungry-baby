...
func main() {
	...
	userChildMealUsecase := _userChildMealUsecase.NewUserChildMealUsecase(timeoutContext, userChildMealRepo, userChildUsecase, mealPlanUsecase, calendarUsecase, userUsecase)

...
func (_m *Usecase) Delete(ctx context.Context, userDomain *user.Domain) (user.Domain, error) {
...
func (_m *Usecase) Find(ctx context.Context, search string, status string, page int, perpage int) ([]user.Domain, int, error) {
...
func (_m *Usecase) FindAll(ctx context.Context, search string, status string) ([]user.Domain, error) {
...
func (_m *Usecase) FindByCode(ctx context.Context, code string, status string) (user.Domain, error) {
...
func (_m *Usecase) FindByEmail(ctx context.Context, email string, status string) (user.Domain, error) {
...
func (_m *Usecase) FindByID(ctx context.Context, id int, status string) (user.Domain, error) {
...
func (_m *Usecase) Store(ctx context.Context, userDomain *user.Domain) (user.Domain, error) {
	ret := _m.Called(ctx, userDomain)
...
func (_m *Usecase) Update(ctx context.Context, userDomain *user.Domain) (user.Domain, error) {
	ret := _m.Called(ctx, userDomain)
